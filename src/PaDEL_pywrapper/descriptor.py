...
class Fingerprint:
    ...
    def _get_sub_descriptor_names(self, path: str):
        ...
        self.description = fps[fps.fingerprint == self.name][['name', 'description']]
...
# from jpype import isJVMStarted, startJVM, shutdownJVM, JPackage, types as jtypes
#
# from .utils import parse_numeric, parse_numeric_to_null, make_temp_jre
#
#
...
#             # Copy JRE to temp
#             self._tmp_dir, self._tmp_jre = make_temp_jre()
#             # Start JVM
#             startJVM(self._tmp_jre, "-ea", f"-Djava.class.path={padel_path}{separator}{epadel_path}")
...
#         """Stops the current process's JVM."""
#         try:
#             shutdownJVM()
#         except:
#             pass
